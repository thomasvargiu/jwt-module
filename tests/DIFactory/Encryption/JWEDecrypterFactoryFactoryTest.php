...
use TMV\JWTModule\DIFactory\Encryption\JWEDecrypterFactoryFactory;

class JWEDecrypterFactoryFactoryTest extends TestCase
{
    public function testInvoke(): void
    {
        ...
        $factory = new JWEDecrypterFactoryFactory();

        $service = $factory($container->reveal());
        $this->assertInstanceOf(JWEDecrypterFactory::class, $service);
    }
}
